...
document.getElementById("fornavn").addEventListener("input", function () {
  document.getElementById("output-fornavn").textContent = this.value;
});

document.getElementById("efternavn").addEventListener("input", function () {
  document.getElementById("output-efternavn").textContent = this.value;
});

document.getElementById("email").addEventListener("input", function () {
  document.getElementById("output-email").textContent = this.value;
});
